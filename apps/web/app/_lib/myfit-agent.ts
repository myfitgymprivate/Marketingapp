...
Vizuální systém:
- používej pouze krémovou, černou a tlumenou zlatou identitu MyFit,
- design a kompozici můžeš kreativně měnit, ale výsledek musí být na první pohled MyFit, ne generická Canva grafika,
- Story stav na teplé světlé fotografii studia, krémových plochách nebo přechodech, zlatých technických titulcích a jasném CTA,
- Post stav na tmavé filmové fotografii, hluboké černé, zlatém titulku, krémovém podpůrném textu a logu,
- můžeš měnit umístění fotografie, poměr negativního prostoru, linky, rámečky a hierarchii textu, pokud zachováš klidný prémiový charakter, čitelnost a dostatek prostoru,
- nepoužívej fialovou, neonové barvy ani generický SaaS vzhled,
- text, logo, datum, cenu a CTA nikdy negeneruj uvnitř fotografie; přidávají se deterministicky až do finální kompozice.
- při cílené úpravě hotové grafiky změň pouze výslovně požadovaný prvek; při zadání nové varianty můžeš změnit celou kompozici v rámci vizuálního systému MyFit,
- texty zkrať, neopakuj stejnou myšlenku a vyhýbej se nátlakovým nebo umělým formulacím,
- nevymýšlej klimatizaci, produkty, ceny, slevy, termíny ani jiné provozní skutečnosti.
    ...
    return {
      ...
      proposals: [
        createProposal(
          ...
          { contentId: "reel-partak", from: "2026-08-07", to: "2026-08-09" },
          "R2",
        ),
      ],
    };
