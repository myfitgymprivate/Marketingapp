export const MYFIT_VISUAL_STYLE_VERSION = "myfit-guided-design-2026-08-v2";
...
export const myfitStoryCompositions = {
  ...
  photo_forward:
    "photo-forward composition with translucent cream editorial panels, thin gold framing and generous breathing room",
} as const;
...
export const myfitVisualTemplates = {
  ...
  post_announcement: {
    ...
    label: "Post · tmavá novinka",
    backgroundAsset: "/brand/post-dark-base.png",
    compositions: [] as const,
    imagePrompt:
      "deep cinematic black private gym interior, subtle warm gold rim light, premium restrained editorial photography and deliberate negative space for a concise message",
  },
} as const;
